import { shouldExpandTxAccordion } from '../TxList/utils'
import { history } from 'src/routes/routes'

describe('shouldExpandTxAccordion', () => {
  it('returns true when a safeTxHash is in the URL', () => {
    ...
    expect(shouldExpandTxAccordion()).toBe(true)
  })
  it('returns undefined when no safeTxHash is in the URL', () => {
    ...
    expect(shouldExpandTxAccordion()).toBe(undefined)
  })
