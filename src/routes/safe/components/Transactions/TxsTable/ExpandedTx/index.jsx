...
const ExpandedTx = ({
  ...
  const cancelThresholdReached = cancelTx.type !== INCOMING_TX_TYPE && threshold <= cancelTx.confirmations.size
  const canExecuteCancel = cancelTx.type !== INCOMING_TX_TYPE && nonce === cancelTx.nonce
