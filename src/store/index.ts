...
import currentSession, { CURRENT_SESSION_REDUCER_ID } from 'logic/currentSession/store/reducer/currentSession'
import notifications, { NOTIFICATIONS_REDUCER_ID } from 'logic/notifications/store/reducer/notifications'
...
import incomingTransactions, { INCOMING_TRANSACTIONS_REDUCER_ID } from 'routes/safe/store/reducer/incomingTransactions'
import safe, { SAFE_REDUCER_ID } from 'routes/safe/store/reducer/safe'
import transactions, { TRANSACTIONS_REDUCER_ID } from 'routes/safe/store/reducer/transactions'
