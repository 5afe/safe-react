...
export const GOOGLE_ANALYTICS_ID_TESTNET = process.env.REACT_APP_GOOGLE_ANALYTICS_ID_TESTNET
export const GOOGLE_ANALYTICS_ID_RSK = process.env.REACT_APP_GOOGLE_ANALYTICS_ID_RSK
