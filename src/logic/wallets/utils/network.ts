 ...
 */
const requestSwitch = async (wallet: Wallet, chainId: string): Promise<void> => {
 ...
 */
const requestAdd = async (wallet: Wallet, chainId: string): Promise<void> => {
  const cfg = getConfig()
 ...
 */
export const switchNetwork = async (wallet: Wallet, chainId: string): Promise<void> => {
  try {
