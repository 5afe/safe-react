...
enum ErrorCodes {
  ...
  _700 = '700: Failed to load a local/session storage item',
  _701 = '701: Failed to save a local/session storage item',
  _702 = '702: Failed to remove a local/session storage item',
