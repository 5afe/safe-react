  ...
  results: [
    {
      ...
      publicRpcUri: { authentication: 'API_KEY_PATH', value: 'https://mainnet.infura.io/v3/' },
    ...
    },
    {
      ...
      publicRpcUri: { authentication: 'API_KEY_PATH', value: 'https://polygon-mainnet.infura.io/v3/' },
      blockExplorerUriTemplate: {
    ...
    },
    {
      ...
      safeAppsRpcUri: { authentication: 'NO_AUTHENTICATION', value: 'https://api.avax.network/ext/bc/C/rpc' },
      publicRpcUri: { authentication: 'NO_AUTHENTICATION', value: 'https://api.avax.network/ext/bc/C/rpc' },
      blockExplorerUriTemplate: {
      ...
      theme: { textColor: '#ffffff', backgroundColor: '#D74F49' },
      gasPrice: [],
      disabledWallets: [
        'authereum',
        'fortmatic',
    ...
    },
    {
      ...
      nativeCurrency: {
        ...
        symbol: 'OETH',
        decimals: 18,
        logoUri: 'https://safe-transaction-assets.staging.gnosisdev.com/chains/10/currency_logo.png',
      },
      theme: { textColor: '#ffffff', backgroundColor: '#EB3431' },
      gasPrice: [],
      disabledWallets: [
        'authereum',
        'coinbase',
    ...
    },
    {
      ...
      publicRpcUri: { authentication: 'API_KEY_PATH', value: 'https://rinkeby.infura.io/v3/' },
      blockExplorerUriTemplate: {
